...
public class FriendApiControllerTests
{
    ...
    public void SetUp()
    {
        ...
        var sharedRecipeRepositoryMock = new Mock<ISharedRecipeRepository>(); // Create mock of ISharedRecipeRepository

        // Arrange
        var blockedUserRepositoryMock = new Mock<IBlockedUserRepository>();
        
        _controller = new FriendApiController(
            _personRepositoryMock.Object,
            _friendshipRepositoryMock.Object,
            _friendRequestRepositoryMock.Object,
            blockedUserRepositoryMock.Object,
            sharedRecipeRepositoryMock.Object); // Pass the mock to the constructor
